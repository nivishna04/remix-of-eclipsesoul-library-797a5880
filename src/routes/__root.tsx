...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Eclipsesoul Library — Restricted Access" },
      { name: "description", content: "Stranger Things inspired library management system. Books, students, fines, reservations, seats." },
      { property: "og:title", content: "Eclipsesoul Library" },
      { property: "og:description", content: "Restricted access library management system." },
